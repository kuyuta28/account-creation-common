...
4 handlers:
  - app_error_handler: catch AppError subclasses → envelope với đúng status_code
  - validation_error_handler: catch RequestValidationError → 422 envelope
  - http_exception_handler: catch StarletteHTTPException → envelope
  - generic_error_handler: catch Exception → 500 envelope (không leak internals)
"""
...
from common.schemas import err
