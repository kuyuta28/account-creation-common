...
def _seed_services_catalog(engine) -> None:
    """Seed services catalog — dùng _SUPPORTED_SERVICES global được set qua set_supported_services()."""
    ...
    with Session(engine) as s:
        ...
        supported_upper = {sv.upper() for sv in _SUPPORTED_SERVICES}
...
# Re-export set_supported_services for convenience
from ._services import set_supported_services