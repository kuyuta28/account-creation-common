...
Mọi JSON endpoint đều trả về ApiResponse[T].
...
Note: Binary endpoints (e.g. /tts returning WAV) không dùng envelope —
chỉ trả raw bytes. Lỗi trên binary endpoints vẫn trả envelope JSON.
"""
